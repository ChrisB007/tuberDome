...
export const creators = () => {
  return (
    ...
    <div className="max-w-7xl mx-auto py-24 px-4 bg-white sm:px-6 lg:px-8">
      ...
      and money you invest in making your videos entertaining as well as resourceful to your subscribers. We serve as liaison between your channels and brands/marketers who would like to align their 
