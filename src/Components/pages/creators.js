  ...
  return (
    ...
    <div className="max-w-7xl mx-auto py-24 px-4 bg-white sm:px-6 lg:px-8">
      ...
      <p className="text-1xl text-margin">
            If you have accumulated 300,000 subscribers, chances are you are already on TuberDome. You know how much it takes to put your videos together, the time and money you invest in making your videos entertaining as well as resourceful to your subscribers. 
